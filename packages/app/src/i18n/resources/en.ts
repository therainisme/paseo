export const en = {
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        addExistingWorkspace: "Add existing workspace",
  ...
  existingWorkspace: {
    ...
    subtitleWithHost: "{{project}} on {{host}}",
    host: "Host",
    searchPlaceholder: "Search branches or enter a path...",
    availableWorktrees: "Available worktrees",
    empty: "No matching worktrees",
    selection: "Selected worktree",
    manualPath: "Use this path",
    directory: "Directory",
    detachedHead: "Detached HEAD",
    paseoManaged: "Paseo-managed",
    mainWorktree: "Main worktree",
    unavailable: "Unavailable",
    external: "External worktree",
    ...
    errors: {
      hostDisconnected: "Host is not connected",
      notGit: "This path is not a Git worktree.",
      differentRepository: "This worktree belongs to a different Git repository.",
      prunable: "This worktree is no longer available on disk.",
      createFailed: "Failed to add workspace",
    },
  },
  branchSwitcher: {
