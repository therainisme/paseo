...
export const zhCN: TranslationResources = {
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        addExistingWorkspace: "添加已有 workspace",
  ...
  existingWorkspace: {
    ...
    subtitleWithHost: "{{host}} 上的 {{project}}",
    host: "Host",
    searchPlaceholder: "搜索分支或输入路径...",
    availableWorktrees: "可用 worktree",
    empty: "没有匹配的 worktree",
    selection: "已选 worktree",
    manualPath: "使用此路径",
    directory: "目录",
    detachedHead: "Detached HEAD",
    paseoManaged: "Paseo 管理",
    mainWorktree: "主 worktree",
    unavailable: "不可用",
    ...
    errors: {
      hostDisconnected: "Host 未连接",
      notGit: "此路径不是 Git worktree。",
      differentRepository: "此 worktree 属于另一个 Git 仓库。",
      prunable: "此 worktree 已不在磁盘上。",
      createFailed: "添加 workspace 失败",
    },
  },
  branchSwitcher: {
