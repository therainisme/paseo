...
export const ar: TranslationResources = {
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        addExistingWorkspace: "إضافة مساحة عمل موجودة",
  ...
  existingWorkspace: {
    title: "إضافة مساحة عمل موجودة",
    subtitleWithHost: "{{project}} على {{host}}",
    host: "Host",
    searchPlaceholder: "ابحث عن فرع أو أدخل مسارًا...",
    availableWorktrees: "مسارات worktree المتاحة",
    empty: "لا توجد مسارات worktree مطابقة",
    selection: "مسار worktree المحدد",
    manualPath: "استخدم هذا المسار",
    directory: "دليل",
    detachedHead: "HEAD منفصل",
    paseoManaged: "تحت إدارة Paseo",
    mainWorktree: "مسار worktree الرئيسي",
    unavailable: "غير متاح",
    external: "worktree خارجي",
    dirty: "تغييرات غير مثبتة",
    clean: "نظيف",
    alreadyAdded: "مضاف بالفعل",
    addWorkspace: "إضافة مساحة العمل",
    openWorkspace: "فتح مساحة العمل",
    errors: {
      hostDisconnected: "الـ Host غير متصل",
      notGit: "هذا المسار ليس Git worktree.",
      differentRepository: "هذا الـ worktree تابع لمستودع Git مختلف.",
      prunable: "لم يعد هذا الـ worktree متاحًا على القرص.",
      createFailed: "تعذرت إضافة مساحة العمل",
    },
  },
  branchSwitcher: {
