...
export const fr: TranslationResources = {
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        addExistingWorkspace: "Ajouter un espace de travail existant",
  ...
  existingWorkspace: {
    title: "Ajouter un espace de travail existant",
    subtitleWithHost: "{{project}} sur {{host}}",
    host: "Host",
    searchPlaceholder: "Rechercher une branche ou saisir un chemin...",
    availableWorktrees: "Worktrees disponibles",
    empty: "Aucun worktree correspondant",
    selection: "Worktree sélectionné",
    manualPath: "Utiliser ce chemin",
    directory: "Répertoire",
    detachedHead: "HEAD détachée",
    paseoManaged: "Géré par Paseo",
    mainWorktree: "Worktree principal",
    unavailable: "Indisponible",
    external: "Worktree externe",
    dirty: "Modifications non validées",
    clean: "Propre",
    alreadyAdded: "Déjà ajouté",
    addWorkspace: "Ajouter l'espace de travail",
    openWorkspace: "Ouvrir l'espace de travail",
    errors: {
      hostDisconnected: "Le Host n'est pas connecté",
      notGit: "Ce chemin n'est pas un worktree Git.",
      differentRepository: "Ce worktree appartient à un autre dépôt Git.",
      prunable: "Ce worktree n'est plus disponible sur le disque.",
      createFailed: "Impossible d'ajouter l'espace de travail",
    },
  },
  branchSwitcher: {
