...
export const es: TranslationResources = {
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        addExistingWorkspace: "Agregar espacio de trabajo existente",
  ...
  existingWorkspace: {
    title: "Agregar espacio de trabajo existente",
    subtitleWithHost: "{{project}} en {{host}}",
    host: "Host",
    searchPlaceholder: "Buscar ramas o introducir una ruta...",
    availableWorktrees: "Worktrees disponibles",
    empty: "No hay worktrees coincidentes",
    selection: "Worktree seleccionado",
    manualPath: "Usar esta ruta",
    directory: "Directorio",
    detachedHead: "HEAD separado",
    paseoManaged: "Gestionado por Paseo",
    mainWorktree: "Worktree principal",
    unavailable: "No disponible",
    external: "Worktree externo",
    ...
    errors: {
      ...
      notGit: "Esta ruta no es un worktree de Git.",
      differentRepository: "Este worktree pertenece a otro repositorio Git.",
      prunable: "Este worktree ya no está disponible en el disco.",
      createFailed: "No se pudo agregar el espacio de trabajo",
    },
  },
  branchSwitcher: {
