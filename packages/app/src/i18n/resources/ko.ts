...
export const ko: TranslationResources = {
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        addExistingWorkspace: "기존 워크스페이스 추가",
  ...
  existingWorkspace: {
    title: "기존 워크스페이스 추가",
    subtitleWithHost: "{{host}}의 {{project}}",
    host: "Host",
    searchPlaceholder: "브랜치를 검색하거나 경로 입력...",
    availableWorktrees: "사용 가능한 worktree",
    empty: "일치하는 worktree 없음",
    selection: "선택한 worktree",
    manualPath: "이 경로 사용",
    directory: "디렉터리",
    detachedHead: "분리된 HEAD",
    paseoManaged: "Paseo 관리",
    mainWorktree: "기본 worktree",
    unavailable: "사용할 수 없음",
    external: "외부 worktree",
    dirty: "커밋되지 않은 변경 사항",
    clean: "변경 없음",
    alreadyAdded: "이미 추가됨",
    ...
    errors: {
      hostDisconnected: "Host가 연결되지 않았습니다",
      notGit: "이 경로는 Git worktree가 아닙니다.",
      differentRepository: "이 worktree는 다른 Git 저장소에 속합니다.",
      prunable: "이 worktree는 더 이상 디스크에 없습니다.",
      createFailed: "워크스페이스를 추가하지 못했습니다",
    },
  },
  branchSwitcher: {
