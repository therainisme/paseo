...
export const ja: TranslationResources = {
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        addExistingWorkspace: "既存のワークスペースを追加",
  ...
  existingWorkspace: {
    title: "既存のワークスペースを追加",
    subtitleWithHost: "{{host}} 上の {{project}}",
    host: "Host",
    searchPlaceholder: "ブランチを検索するかパスを入力...",
    availableWorktrees: "利用可能な worktree",
    empty: "一致する worktree はありません",
    selection: "選択した worktree",
    manualPath: "このパスを使用",
    directory: "ディレクトリ",
    detachedHead: "Detached HEAD",
    paseoManaged: "Paseo 管理",
    mainWorktree: "メイン worktree",
    unavailable: "利用不可",
    external: "外部 worktree",
    dirty: "未コミットの変更あり",
    clean: "変更なし",
    alreadyAdded: "追加済み",
    ...
    errors: {
      hostDisconnected: "Host が接続されていません",
      notGit: "このパスは Git worktree ではありません。",
      differentRepository: "この worktree は別の Git リポジトリに属しています。",
      prunable: "この worktree はディスク上に存在しません。",
      createFailed: "ワークスペースを追加できませんでした",
    },
  },
  branchSwitcher: {
