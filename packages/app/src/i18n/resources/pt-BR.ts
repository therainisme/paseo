...
export const ptBR: TranslationResources = {
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        addExistingWorkspace: "Adicionar workspace existente",
  ...
  existingWorkspace: {
    title: "Adicionar workspace existente",
    subtitleWithHost: "{{project}} em {{host}}",
    host: "Host",
    searchPlaceholder: "Buscar branches ou informar um caminho...",
    availableWorktrees: "Worktrees disponíveis",
    empty: "Nenhum worktree correspondente",
    selection: "Worktree selecionado",
    manualPath: "Usar este caminho",
    directory: "Diretório",
    detachedHead: "HEAD desconectado",
    paseoManaged: "Gerenciado pelo Paseo",
    ...
    errors: {
      ...
      notGit: "Este caminho não é um worktree Git.",
      differentRepository: "Este worktree pertence a outro repositório Git.",
      prunable: "Este worktree não está mais disponível no disco.",
      createFailed: "Falha ao adicionar workspace",
    },
  },
  branchSwitcher: {
