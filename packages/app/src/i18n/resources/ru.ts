...
export const ru: TranslationResources = {
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        addExistingWorkspace: "Добавить существующее рабочее пространство",
  ...
  existingWorkspace: {
    title: "Добавить существующее рабочее пространство",
    subtitleWithHost: "{{project}} на {{host}}",
    host: "Host",
    searchPlaceholder: "Найти ветку или ввести путь...",
    availableWorktrees: "Доступные worktree",
    empty: "Подходящие worktree не найдены",
    selection: "Выбранный worktree",
    manualPath: "Использовать этот путь",
    directory: "Каталог",
    detachedHead: "Отделённый HEAD",
    paseoManaged: "Управляется Paseo",
    mainWorktree: "Основной worktree",
    unavailable: "Недоступен",
    external: "Внешний worktree",
    ...
    errors: {
      hostDisconnected: "Host не подключён",
      notGit: "Этот путь не является Git worktree.",
      differentRepository: "Этот worktree относится к другому Git-репозиторию.",
      prunable: "Этот worktree больше недоступен на диске.",
      createFailed: "Не удалось добавить рабочее пространство",
    },
  },
  branchSwitcher: {
  ...
  settings: {
    ...
    notifications: {
      ...
      osPreviews: "Показывать содержимое сообщений",
      osPreviewsHint:
        "Включать вывод агента в уведомления. Они остаются видимыми на экране блокировки и синхронизируются с подключёнными устройствами.",
